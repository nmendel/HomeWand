...
for s in commands:
    ...
    os.system(cmd)
"""
cmd = 'platform-tools-latest-windows\\platform-tools\\adb.exe -s ZX1F222566 shell "run-as edu.gmu.mendel.homewand cat /data/data/edu.gmu.mendel.homewand/files/signature.arff" > homewand.arff'
print cmd
os.system(cmd)