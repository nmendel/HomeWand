...
public class HomeWandDocumentsProvider extends DocumentsProvider {
    ...
    public Cursor queryRoots(final String[] projection) throws FileNotFoundException {
        ...
        // Add Home directory
        File homeDir = new File("/data/data/edu.gmu.mendel.homewand/files");
        Log.i("provider_home_dir", homeDir.toString());
    ...
    public String createDocument(final String parentDocumentId, final String mimeType,
        ...
        try {
            ...
            Log.e(HomeWandDocumentsProvider.class.getSimpleName(), "Error creating new file " + newFile);
        }
        return null;
    }
    ...
    public AssetFileDescriptor openDocumentThumbnail(final String documentId, final Point sizeHint,
        ...
        try {
            ...
            Log.e(HomeWandDocumentsProvider.class.getSimpleName(), "Error writing thumbnail", e);
            return null;
        } finally {
            if (out != null)
                try {
                    ...
                    Log.e(HomeWandDocumentsProvider.class.getSimpleName(), "Error closing thumbnail", e);
                }
        }
